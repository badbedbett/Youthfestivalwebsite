...
const venues: Venue[] = [
  ...
  },
  {
    ...
    offer: 'Завтрак с ветчиной и картофельными крокетами — 790 руб.\nСэндвич с ветчиной и трюфельным айоли — 890 руб.\nФлак-круассан с малиновым джемом — 890 руб.',
    price: 'от 790 руб.',
  ...
  },
  {
    ...
    offer: 'Овсянка с томатами и сыром Гауда — 280 руб.\nСырники из деревенского творога с клюквенным соусом — 380 руб.\nСэндвич с яйцом, зеленым луком и домашним айоли — 380 руб.\nСалат с куриной грудкой, маринованными персиками и арахисом — 550 руб.',
    price: 'от 280 руб.',
  ...
  },
  {
    ...
    offer: 'Крок-месье (Тартин, пастрами из индейки, соус бешамель (молоко, пшеничная мука, соль, сливочное масло), пармезан, дижонская горчица, лук резанец) — 620 руб.\nСкрэмбл с колбаской индейки (Скрамбл из двух яиц, колбаска из курицы и индейки, помидоры, шпинат, мятное песто, шпинат) — 640 руб.\nВатрушка (Пшеничная мука, творог, яйцо, ванильная паста, кислосливочное масло, сахар, дрожжи, клейковина, сливочное масло, мед, соль, вода) — 360 руб.',
    price: 'от 360 руб.',
  ...
  },
  {
    id: 'cups',
    name: 'CUPS',
    description: 'Городское кафе от Fine Group на каждый день с разнообразными завтраками, цветочным интерьером и теплой атмосферой',
    offer: 'Круассан с мороженым и ягодами — 310 руб.\nЭспрессо тоник со смородиной — 410 руб.',
    price: 'от 310 руб.',
  ...
  },
  {
    id: 'aulak',
    name: 'Аулак',
    description: 'Кофейня от Fine Group в Казанском Кремле с современным прочтением татарской кухни.',
    offer: 'Каймак-тост с мороженым из душицы и ягодами — 490 руб.\nТатарский фильтр с облепихой — 340 руб.',
    price: 'от 340 руб.',
  ...
  },
  {
    ...
    offer: 'Хот-дог с говядиной — 550 руб.\nТакос по мексикански — 700 руб.\nКоктейль «Сицилийский пунш» — 700 руб.',
    price: 'от 550 руб.',
