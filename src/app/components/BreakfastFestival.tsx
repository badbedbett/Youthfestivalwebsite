...
const venues: Venue[] = [
  ...
  },
  {
    id: 'utro',
    name: 'Утро',
    description: 'Проект с философией «когда завтрак — тогда и утро». Здесь кормят завтраками до 18:00, предлагая разные его вариации в виде конструкторов и отдельных позиций.',
  ...
  },
  {
    ...
    offer: 'Сендвич с тунцом и омлетом\nКапучино 0,2',
    price: 'Уточняйте в заведении',
  ...
  },
  {
    id: 'zelgrechka',
    name: 'Зеленая гречка',
    description: 'Гастрономическое пространство, где вкус сочетается с заботой и вдохновением. Здесь готовят простую еду из натуральных ингредиентах.',
  ...
  },
  {
    id: 'branch',
    name: 'Branch bistro',
    description: 'Cтильное бистро с минималистичным интерьером и атмосферой будущего, где идет акцент на современные гастрономические практики.',
    offer: 'Уточняйте специальное предложение в заведении',
    price: 'Уточняйте в заведении',
    address: 'ул. Сибгата Хакима, 62',
    hours: 'ежедневно с 08:30 до 21:00',
    contacts: 'https://branchgroup.ru/bistrohome',
    category: ['Рестораны'],
    tags: ['Завтраки'],
  },
  {
  ...
  },
  {
    id: 'oko',
    name: 'Око',
    description: 'Видовой ресторан с авторской кухней на стыке татарских традиций и мировых трендов.',
    offer: 'Уточняйте специальное предложение в заведении',
    price: 'Уточняйте в заведении',
    address: 'ул. Чернышевского, 21',
    hours: 'вс — чт с 12:00 до 23:00, пт — сб с 12:00 до 01:00',
    contacts: 'https://oko.rest/; https://vk.com/okokazan',
    category: ['Рестораны'],
    tags: ['Завтраки'],
  },
  {
